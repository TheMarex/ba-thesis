...
1m distance at the chest.
See figure \ref{img:disturbed-straight-x} for the realited CoM and ZMP trajectories. The point of impact is denoted as red lines.
The unstabilized trajectory becomes unstable and leads to a fall at $t = 9.5s$. The stabilized
trajectory is noticable disturbed, as the yaw momentum is not compensated, but remains stable.
