...
both walking straight and walking in circle were tested.
...
in both cases. As can be seen, the ZMP deviates significantly from the desired trajectory
...
As you can be seen, the desired 180° turn is not realized completely. Due to the
