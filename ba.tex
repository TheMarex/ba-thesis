...
and $y$ coordinates are calculated accordingly. The foot orientation is
...
stabilizer is activated again to hold the current position. Resuming the
...
football is used as source of disturbance.
