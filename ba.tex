...
generated automatically for very simulation.
...
\section{Detecting a deviation}\label{detecting-a-deviation}
...
assumed while generating the pattern. Thus it seems more viable to check
for a diviation in the trajectory of our CoM. A common approach to
correct for CoM position is to control the pose of the chest frame of
the robot. This only works if the majority of the mass of a robot is
located in the upper body and arms. Luckily for most humanoid robots
this is the case.
